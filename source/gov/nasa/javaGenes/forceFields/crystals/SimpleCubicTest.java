...
import gov.nasa.javaGenes.forceFields.MultiBody;
import gov.nasa.javaGenes.forceFields.ThreeBody;
import gov.nasa.javaGenes.forceFields.TwoBody;
import junit.framework.TestCase;

public class SimpleCubicTest extends TestCase {

    public SimpleCubicTest(String name) {
        super(name);
    }
