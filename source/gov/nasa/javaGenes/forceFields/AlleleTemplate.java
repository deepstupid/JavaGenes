...
public class AlleleTemplate implements Serializable {
    ...
    public int getSize(int index) {
        return alleles[index].length;
    }

    public Allele getAllele(int i, int j) {
        return alleles[i][j];
    }
     ...
     */
    public boolean hasAllele(int i, int j) {
        return alleles[i][j] != null;
    }

    public void setAllele(Allele allele, int i, int j) {
        alleles[i][j] = allele;
    }
