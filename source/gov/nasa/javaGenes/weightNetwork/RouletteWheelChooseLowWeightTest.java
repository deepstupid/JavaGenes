...
public class RouletteWheelChooseLowWeightTest extends TestCase {
    private RouletteWheelChooseLowWeight wheel;
    private Weight w1;
    private Weight w2;
    private Weight w3;
    private Weight w4;

    public RouletteWheelChooseLowWeightTest(String name) {
        super(name);
    }

    public void setUp() {
        wheel = new RouletteWheelChooseLowWeight();
        w1 = new Weight();
        w1.setWeight(4);
        w2 = new Weight();
        w2.setWeight(3);
