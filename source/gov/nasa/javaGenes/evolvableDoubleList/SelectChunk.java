...
public class SelectChunk extends Selector {
    ...
    public SelectChunk(int[] numberToChoose) {
        this(numberToChoose, 1, 0);
    }

    public SelectChunk(int[] numberToChoose, int modulo) {
        this(numberToChoose, modulo, 0);
    }

    public SelectChunk(int[] numberToChoose, int modulo, int offset) {
        this(new SelectOne(), numberToChoose, modulo, offset);
    }
