...
public class EvolvableDouble implements java.io.Serializable {
    ...
    static public double limitToLegalRange(double value) {
        return universalRange.limitTo(value);
    }

    static public boolean isWithinRange(double value) {
        return universalRange.isBetween(value);
    }
    ...
    public void setValue(double value) {
        this.value = universalRange.limitTo(value);
    }

    public boolean isEqual(EvolvableDouble other) {
        return Utility.nearlyEqual(getValue(), other.getValue());
    }
