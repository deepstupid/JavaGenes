...
public class Task implements java.io.Serializable {
    ...
    public static String getReportHeader() {
        return "Duration\tPriority\tNumberOfAccessWindows";
    }
    ...
    public double getPriority() {
        return priority;
    } // higher priorities more important
    ...
    public boolean areAccessWindowsInEarliestFirstOrder() {
        return accessWindowsArray != null;
    }
    ...
    public int numberOfAccessWindows() {
        return accessWindowsArray.length;
    }

    public AccessWindow getAccessWindow(int i) {
        return accessWindowsArray[i];
    }
}
