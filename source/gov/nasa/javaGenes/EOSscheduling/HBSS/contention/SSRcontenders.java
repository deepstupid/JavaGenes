...
public class SSRcontenders extends WeightList {
    ...
    static public void beginMarking() {
        markValue++;
    }
    ...
    public void addAccessWindowWeight(AccessWindowWeight aw) {
        add(new SSRcontendersNode(aw));
    }
    ...
    protected SSRNode getSSRnode() {
        return theSSRNode;
    }

    protected void setSSRnode(Node node) {
        theSSRNode = (SSRNode) node;
    }

    public int getSSRcapacity() {
        return theSSRNode.getRemainingCapacity();
    }

    // of AccessWindowWeights -- all the same
    public float getSSRcontention() {
        return SSRcontention.getCurrent();
    }
    ...
    public SSRcontendersNode getFirstSCN() {
        return (SSRcontendersNode) getFirst();
    }
    ...
    public float getSSRneedSum() {
        return SSRneedSum.getCurrent();
    }

    public float getSSRoldContention() {
        return SSRoldContention;
    }

    public boolean isMarked() {
        return myMark == markValue;
    }
