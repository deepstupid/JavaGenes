...
public class AccessWindowsList extends gov.nasa.javaGenes.EOSscheduling.HBSS.AccessWindowsList {
    ...
    public int getNumberOfUndecidedAccessWindows() {
        return numberOfUndecidedAccessWindows.getCurrent();
    }
    ...
    public AccessWindowWeight getAccessWindowWeight(int index) {
        return (AccessWindowWeight) getWeight(index);
    }

    public AccessWindowWeight getFirstAW() {
        return (AccessWindowWeight) getFirst();
    }
}
