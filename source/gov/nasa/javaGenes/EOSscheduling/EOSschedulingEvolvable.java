...
public class EOSschedulingEvolvable extends PermutationEvolvable {
    ...
    */
    public void setTaskPlacement(int index, TaskPlacementData data) {
        taskPlacements[index].setFrom(data);
    }

    public TaskPlacementData getTaskPlacement(int index) {
        return taskPlacements[index];
    }

    public int getStartTime(int index) {
        return taskPlacements[index].getStartTime();
    }

    public void setStartTime(int index, int time) {
        taskPlacements[index].setStartTime(time);
    }

    public int getSensorNumber(int index) {
        return taskPlacements[index].getSensorNumber();
    }

    public void setSensorNumber(int index, int sensor) {
        taskPlacements[index].setSensorNumber(sensor);
    }

    public SlewRequirement getSlewRequirement(int index) {
        return taskPlacements[index].getSlewRequirement();
    }

    public void setSlewRequirement(int index, SlewRequirement inSlewRequirement) {
        taskPlacements[index].setSlewRequirement(inSlewRequirement);
    }

    public boolean hasBeenScheduled() {
        return hasBeenScheduledAlready;
    }

    public void setHasBeenScheduled(boolean value) {
        hasBeenScheduledAlready = value;
    }

    public boolean isTaskScheduled(int index) {
        return taskPlacements[index].isScheduled();
    }
