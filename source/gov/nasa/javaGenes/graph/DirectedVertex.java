...
//public DirectedVertex(TokenizeInput tokenizer) {super(tokenizer);}
    ...
    public DirectedEdge getInputEdge(int i) {
        return (DirectedEdge) inputEdges.elementAt(i);
    }

    public DirectedEdge getOutputEdge(int i) {
        return (DirectedEdge) outputEdges.elementAt(i);
    }
    ...
    public boolean hasInputEdges() {
        return inputEdges.size() > 0;
    }

    public EdgeIterator getInputEdgeIterator() {
        return new EdgeIterator(inputEdges);
    }

    public EdgeIterator getOutputEdgeIterator() {
        return new EdgeIterator(outputEdges);
    }
