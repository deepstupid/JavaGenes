...
public class TokenizeInput {
    ...
    public boolean getBoolean() {
        return Utility.string2boolean(getLine());
    }

    public int getInteger() {
        return Utility.string2integer(getLine());
    }

    public long getLong() {
        return Utility.string2long(getLine());
    }

    public double getDouble() {
        return Utility.string2double(getLine());
    }
    ...
    public void close() {
        try {
            ...
            Error.fatal("can't close file " + filename);
        }
        input = null;
    }
    ...
    protected String getLine() {
        ...
        try {
            ...
            Error.fatal("input error reading from file " + filename);
        }
        return string;
    }
