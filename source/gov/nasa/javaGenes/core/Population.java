...
public class Population implements Serializable {
    ...
    public IntegerInterval getIndexRange() {
        return new IntegerInterval(0, getLastIndex());
    }
    ...
    public Fitness getFitness(int i) {
        return getIndividual(i).getFitness();
    }

    public Evolvable getEvolvable(int i) {
        return getIndividual(i).getEvolvable();
    }
...
// PERFORMANCE: put indices in the individuals
    ...
    */
    ...
    public Individual worstIndividual(Fitness mustBeBetterThan) throws NotFoundException {
        return population[worstIndividualIndex(mustBeBetterThan)];
    }

    public Fitness worstFitness(Fitness mustBeBetterThan) throws NotFoundException {
        return worstIndividual(mustBeBetterThan).getFitness();
    }
    ...
    public Individual pick() {
        return population[RandomNumber.getIndex(population.length)];
    }
    ...
    public String getUniqueLogValueHeader() {
        return "size ";
    }
