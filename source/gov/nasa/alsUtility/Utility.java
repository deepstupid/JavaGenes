...
public class Utility {
    ...
    static public Date stkDateString2Date(String stkDateString) {
        ...
        try {
            ...
            Error.fatal(stkDateString + " caused " + e);
        }
        return r;
    }
    ...
    public static boolean areDifferent(int[] array) {
        return areDifferent(array, array.length - 1);
    }
    ...
    public static Object newInstance(Object instance, Object argument) {
        try {
            ...
            Error.fatal("Can't make instance: " + e);
        }
        return null;
    }
    ...
    public static boolean isOdd(int i) {
        return (java.lang.Math.abs(i) & 1) == 1;
    }
...
*/
    ...
    public static void setPermissions(String file, String permissions) {
        try {
            ...
            Error.fatal("chmod problem " + e + " filename " + file);
        } catch (IOException e) {
            Error.fatal("chmod problem " + e + " filename " + file);
        }
    }
